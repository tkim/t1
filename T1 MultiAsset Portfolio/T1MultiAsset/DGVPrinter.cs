...
{    
    ...
    public class DGVPrinter
    {
        ...
        void SetupPrint()
        {
            if (EnableLogging) Logger.LogInfoMsg("SetupPrint process started");
        ...
        private void RecalcRowHeights(Graphics g, int colindex, float newcolwidth)
        {
            ...
            for (int i = 0; i < rowstoprint.Count; i++)
            {
                ...
                if (RowHeightSetting.DataHeight == RowHeight)
                {
                    ...
                    SizeF size = calccellsize(g, cell, colindex, colstyle, newcolwidth, currentformat);
        ...
        private void measureprintarea(Graphics g)
        {
            ...
            for (i = 0; i < colstoprint.Count; i++)
            {
                ...
                else if ((ColumnWidthSetting.CellWidth == ColumnWidth) || (ColumnWidthSetting.Porportional == ColumnWidth))
                {
                    ...
                    size = calccellsize(g, col.HeaderCell, i,
        ...
        private bool PrintPage(Graphics g)
        {
            ...
            if (EnableLogging) Logger.LogInfoMsg(String.Format("Print Page printing page {0} part {1}", CurrentPage, currentpageset + 1));
        ...
        private void printfooter(Graphics g, ref float pos, Margins margins)
        {
            ...
            printsection(g, ref pos, footer, footerfont, footercolor, footerformat,
                overridefooterformat, margins, footerbackground, footerborder);
            ...
            if (!pagenumberontop)
            {
                if (pageno)
                {
                    ...
                    printsection(g, ref pos, pagenumber, pagenofont, pagenocolor, pagenumberformat,
                        overridepagenumberformat, margins, null, null);
                }
            }
        }
